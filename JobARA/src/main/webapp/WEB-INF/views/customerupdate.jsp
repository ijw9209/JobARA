		...
		<form action="customerupdateres.do" method="post" novalidate onsubmit="inquiryres()">
			...
			<table border="1">
				<thead>
					<tr>
						<th>제목</th>
						<td><input type="text" name="customer_title" value="${dto.customer_title }"/></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea id="summernote" name="customer_content" rows="10" cols="60">${dto.customer_content }</textarea></td>
					</tr>
					<tr>
						<th>Email</th>
						<td><input type="text" name="customer_email" value="${dto.customer_email }"/></td>
					</tr>
				</thead>
				<tbody>
					<tr>
